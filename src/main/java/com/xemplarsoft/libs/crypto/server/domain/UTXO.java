...
public class UTXO extends UTXOverview {
	...
	public UTXO(){}
	public UTXO(String txId, Integer vOut, String scriptPubKey, String redeemScript) {
		super(txId, vOut);
		this.scriptPubKey = scriptPubKey;
		this.redeemScript = redeemScript;
	}

	public UTXO(String address, String account, String scriptPubKey, String redeemScript,
