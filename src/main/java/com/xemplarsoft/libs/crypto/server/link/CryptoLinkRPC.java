...
public interface CryptoLinkRPC {
	...
	String createRawTransaction(List<UTXOverview> outputs, Map<String, BigDecimal> toAddresses)
			throws CryptocoinException, CommunicationException;
	...
	List<UTXOverview> listLockUnspent() throws CryptocoinException, CommunicationException;
	...
	List<UTXO> listUnspent() throws CryptocoinException, CommunicationException;

	List<UTXO> listUnspent(Integer minConfirmations) throws CryptocoinException,
			CommunicationException;

	List<UTXO> listUnspent(Integer minConfirmations, Integer maxConfirmations)
			throws CryptocoinException, CommunicationException;
	...
	Boolean lockUnspent(Boolean isUnlocked, List<UTXOverview> outputs) throws CryptocoinException,
			CommunicationException;
	...
	String sendToAddress(String toAddress, BigDecimal amount, String comment, String commentTo, String narration)
			throws CryptocoinException, CommunicationException;

	String sendToAddress(String toAddress, BigDecimal amount, String narration, boolean type)
			throws CryptocoinException, CommunicationException;
	...
	SignatureResult signRawTransaction(String hexTransaction, List<UTXO> utxos)
			throws CryptocoinException, CommunicationException;
